...
$max_slew = 0; #self-use
$min_slew = $SLEWLIMIT; #self-use
$max_slew_lab = 0; #self-use
...
$maxNominalSkew = $maxLatency - $minLatency
...
printf ("%s %s CLR %.3f (ps) C %.3f (s %.3f b %.3f w %.3f)(fF) maxNominalSkew %.3f maxSlew %.3f minSlew %.3f\n",$inFileO, $resultFileO, $maxLatency-$minLatency, $resultTotCap, $totSinkCap, $totBufCap, $totWireCap, $maxNominalSkew, $max_slew, $min_slew);
